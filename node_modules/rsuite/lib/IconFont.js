...
var IconFont = _react2.default.createClass({
    ...
    render: function render() {
        ...
        var props = _objectWithoutProperties(_props, ['componentClass', 'className', 'classPrefix', 'icon']);

        var classes = (0, _classnames2.default)(classPrefix, this.prefix(icon), className);
